...
For requests, rooms can be associated with groups in addition to individual PIs. Any members belonging to a group associated with a PI can approve a request on behalf of the entire group.
## 1.0 Managing Groups
...
The All Room Groups page can be accessed by clicking the All Room Groups tabs located on the left side menu of the Requests page (Figure 1.5).
