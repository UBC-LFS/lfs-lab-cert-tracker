...
urlpatterns += [
    ...
    path('requests/archived/', admin_views.ArchivedRequests.as_view(), name='archived_requests'),
    path('rooms/expired/', admin_views.ExpiredRooms.as_view(), name='expired_rooms'),
