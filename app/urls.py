...
urlpatterns = [
    ...
    # Users - classes
    path('users/report/missing-trainings/', views.UserReportMissingTrainings.as_view(), name='user_report_missing_trainings'),
    path('users/new/', views.NewUser.as_view(), name='new_user'),
    path('users/all/', views.AllUsers.as_view(), name='all_users'),

    path('users/<int:user_id>/work-area/', views.UserAreas.as_view(), name='user_areas'),
    path('users/<int:user_id>/work-area/<int:area_id>/access-request/', views.AccessRequest.as_view(), name='access_request'),

    path('users/<int:user_id>/', views.UserDetails.as_view(), name='user_details'),
    path('users/<int:user_id>/training-record/', views.UserTrainings.as_view(), name='user_trainings'),
    path('users/<int:user_id>/training-record/<int:training_id>/', views.UserTrainingDetails.as_view(), name='user_training_details'),
    ...
    # Areas - classes
    path('areas/all/', views.AllAreas.as_view(), name='all_areas'),
    path('areas/<int:area_id>/', views.AreaDetails.as_view(), name='area_details'),
    ...
    # Trainings - classes
    path('trainings/all/', views.AllTrainings.as_view(), name='all_trainings'),
