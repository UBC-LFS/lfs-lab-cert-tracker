...
class TrainingTest(TestCase):
    ...
    """def test_check_access_normal_user(self):
        ...
        res = self.client.get(reverse('app:all_trainings'))
    ...
    def test_create_training(self):
        ...
        res = self.client.post(reverse('app:all_trainings'), data=urlencode(data), content_type=ContentType)
    ...
    def test_edit_training_name(self):
        ...
        res = self.client.post(reverse('app:edit_training'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_delete_training(self):
        ...
        res = self.client.post(reverse('app:delete_training'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
