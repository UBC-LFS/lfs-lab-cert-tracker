...
class AreaTest(TestCase):
    ...
    def test_check_access_pi(self):
        ...
        res = self.client.get(reverse('app:area_details', args=[5]))
        self.assertEqual(res.status_code, 403)
    ...
    def test_create_area_success(self):
        ...
        res = self.client.post(reverse('app:all_areas'), data=urlencode(data), content_type=ContentType)
    ...
    def test_edit_area_success(self):
        ...
        res = self.client.post(reverse('app:edit_area'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_delete_area(self):
        ...
        res = self.client.post(reverse('app:delete_area'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_area_details(self):
        ...
        res = self.client.get(reverse('app:area_details', args=[area_id]))
        self.assertEqual(res.status_code, 200)
    ...
    def test_add_training_to_area(self):
        ...
        res = self.client.post(reverse('app:add_training_area'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
        self.assertEqual(messages[0], 'Success! Anesthesia of the Laboratory Rodent added.')
        self.assertEqual(res.status_code, 302)
        self.assertEqual(res.url, reverse('app:area_details', args=[1]))
        self.assertRedirects(res, res.url)
    ...
    def test_delete_training_in_area(self):
        ...
        res = self.client.post(reverse('app:delete_training_in_area'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
        self.assertEqual(messages[0], 'Success! Workplace Violence Prevention Training deleted.')
        self.assertEqual(res.status_code, 302)
        self.assertEqual(res.url, reverse('app:area_details', args=[area.id]))
        self.assertRedirects(res, res.url)
    ...
    def test_add_user_to_area(self):
        ...
        res = self.client.post(reverse('app:area_details', args=[area.id]), data=urlencode(data), content_type=ContentType)
        self.assertEqual(res.status_code, 302)
        messages = self.messages(res)
        print(messages)
    ...
    def test_switch_role_user_to_pi(self):
        ...
        res = self.client.post(reverse('app:switch_user_role_in_area', args=[area.id]), data=urlencode(data), content_type=ContentType)
        self.assertEqual(res.status_code, 302)
        messages = self.messages(res)
    ...
    def test_switch_role_invalid_area(self):
        ...
        res = self.client.post(reverse('app:switch_user_role_in_area', args=[100]), data=urlencode(data), content_type=ContentType)
        self.assertEqual(res.status_code, 404)
    ...
    def test_delete_user_in_area(self):
        ...
        res = self.client.post(reverse('app:delete_user_in_area', args=[area.id]), data=urlencode(data), content_type=ContentType)
        self.assertEqual(res.status_code, 302)
        messages = self.messages(res)
