...
class UserTest(TestCase):
    ...
    def test_check_access_normal_user(self):
        ...
        res = self.client.get(reverse('app:all_users')) # all users
        ...
        res = self.client.get(reverse('app:user_report', args=[lab_user.id])) # lab user
        self.assertEqual(res.status_code, 200)

        res = self.client.get(reverse('app:user_report', args=[lab_user2.id])) # Wrong lab user
        self.assertEqual(res.status_code, 403)
    ...
    def test_check_access_pi(self):
        ...
        res = self.client.get(reverse('app:user_report', args=[pi.id]))
        self.assertEqual(res.status_code, 200)
    ...
    def test_check_access_admin(self):
        ...
        res = self.client.get(reverse('app:all_users') + ALL_USERS_QUERY)
        self.assertEqual(res.status_code, 200)
        ...
        res = self.client.get(reverse('app:user_report', args=[admin.id]))
        self.assertEqual(res.status_code, 200)

        res = self.client.get(reverse('app:user_report', args=[pi.id]))
        self.assertEqual(res.status_code, 200)

        res = self.client.get(reverse('app:user_report', args=[lab_user.id]))
        self.assertEqual(res.status_code, 200)

        res = self.client.get(reverse('app:user_report', args=[lab_user2.id]))
        self.assertEqual(res.status_code, 200)
    ...
    def test_edit_user_duplicated_username(self):
        ...
        data = {
            ...
            'email': EMAIL,
            'user': user.id,
            'next': reverse('app:all_users') + ALL_USERS_QUERY
        }
        res = self.client.post(reverse('app:all_users'), data=urlencode(data), content_type=ContentType)
        ...
        self.assertEqual(res.url, reverse('app:all_users') + ALL_USERS_QUERY)
    ...
    def test_edit_user_firstname_long(self):
        ...
        res = self.client.post(reverse('app:all_users') + ALL_USERS_QUERY, data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_grant_admin(self):
        ...
        res = self.client.post(reverse('app:switch_admin'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_inactive_user(self):
        ...
        res = self.client.post(reverse('app:switch_inactive'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_active_user(self):
        ...
        res = self.client.post(reverse('app:switch_inactive'), data=urlencode(data1), content_type=ContentType)
        messages = self.messages(res)
        self.assertEqual(messages[0], 'Success! test user1 is now INACTIVE.')
        ...
        res2 = self.client.post(reverse('app:switch_inactive'), data=urlencode(data2), content_type=ContentType)
    ...
    def test_delete_user(self):
        ...
        res = self.client.post(reverse('app:delete_user'), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
    ...
    def test_user_logged_first_time_success(self):
        ...
        res = self.client.post(reverse('app:read_welcome_message', args=[user.id]), data=urlencode({ 'read_welcome_message': 'true' }), content_type=ContentType)
    ...
    def test_user_logged_first_time_failture(self):
        ...
        # read a welcome message
        res = self.client.post(reverse('app:read_welcome_message', args=[user.id]), data=urlencode({ 'read_welcome_message': 't' }), content_type=ContentType)
        content = json.loads(res.content)
    ...
    def test_user_report_missing_trainings(self):
        ...
        res = self.client.get(reverse('app:user_report_missing_trainings'))
        self.assertEqual(res.status_code, 200)
...
class UserAreaTest(TestCase):
    ...
    def test_assign_areas_to_user_one_selected(self):
        ...
        res = self.client.post( reverse('app:assign_user_areas'), data=urlencode(data1, True), content_type=ContentType )
        self.assertEqual(res.status_code, 200)
        ...
        res = self.client.post( reverse('app:assign_user_areas'), data=urlencode(data2, True), content_type=ContentType )
        self.assertEqual(res.status_code, 200)
        messages = self.json_messages(res)
        self.assertEqual(messages['status'], 'success')
    ...
    def test_assign_areas_to_user_two_selected(self):
        ...
        res = self.client.post( reverse('app:assign_user_areas'), data=urlencode(data, True), content_type=ContentType )
        self.assertEqual(res.status_code, 200)
        messages = self.json_messages(res)
        self.assertEqual(messages['status'], 'success')
...
class UserTrainingTest(TestCase):
    ...
    def test_delete_user_training_by_admin(self):
        ...
        res = self.client.post(reverse('app:delete_user_training', args=[user_id]), data=urlencode(data), content_type=ContentType)
        messages = self.messages(res)
        self.assertEqual(res.status_code, 302)
    ...
    def test_user_report(self):
        ...
        res = self.client.get(reverse('app:user_report', args=[user.id]))
        self.assertEqual(res.context['app_user'].id, user.id)
        self.assertEqual(res.context['app_user'].username, user.username)
